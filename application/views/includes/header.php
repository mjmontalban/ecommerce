							...
							<div class="sinlge-bar shopping">
								...
								<div class="shopping-item">
									<div class="dropdown-cart-header">
										<span>2 Items</span>
										<a href="<?php echo base_url('view_cart'); ?>">View Cart</a>
									</div>
									...
									<div class="bottom">
										...
										<a href="<?php echo base_url('checkout'); ?>" class="btn animate">Checkout</a>
									</div>
								</div>
								<!--/ End Shopping Item -->
							</div>
		...
		<div class="header-inner">
			<div class="container">
				<div class="cat-nav-head">
					<div class="row">
				        <?php if ($main_content == 'ecommerce/index'): ?>
                  <div class="col-lg-3">
										...
										<div class="nav-inner">
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Shop<i class="ti-angle-down"></i><span class="new">New</span></a>
														<ul class="dropdown">
															<li><a href="<?php echo base_url('shop_grid'); ?>">Shop Grid</a></li>
															<li><a href="<?php echo base_url('view_cart'); ?>">Cart</a></li>
